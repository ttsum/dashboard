...
import { ACTIVE_PROVINCE } from './provinceDashboard'
...
export const MAP_NAME = ACTIVE_PROVINCE.mapName
export const MAP_SOURCE_TEXT = `数据来源：中国县域统计数据 与${ACTIVE_PROVINCE.name}行政区划边界数据`
